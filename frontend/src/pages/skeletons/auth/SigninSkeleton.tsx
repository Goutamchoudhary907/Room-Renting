    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="flex flex-1 animate-pulse items-center justify-center bg-cream px-5 py-8 sm:px-12 sm:py-12">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-9 h-4 w-52 rounded bg-cream-border-soft" />

          <div className="mb-7 h-11 w-full rounded-[14px] bg-cream-border-soft" />

          <div className="mb-7 flex items-center gap-4">
            <div className="h-px flex-1 bg-cream-border" />
            <div className="h-3 w-40 rounded bg-cream-border-soft" />
            <div className="h-px flex-1 bg-cream-border" />
          </div>
          ...
          <div className="mb-7 flex flex-col gap-5">
            {[0, 1].map((i) => (
              <div key={i}>
                <div className="mb-2 h-3 w-28 rounded bg-cream-border-soft" />
