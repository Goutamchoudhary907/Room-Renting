export const SignupSkeleton = () => {
    return (
      <div className="min-h-screen flex justify-center items-start pt-4 md:pt-8 bg-gray-200 p-4">
        <div className="w-[1000px] h-[650px] lg:w-full lg:max-w-[1000px] lg:h-auto lg:min-h-[650px] flex rounded-lg bg-white lg:flex-row flex-col max-lg:h-full max-lg:w-full max-lg:rounded-none">
          ...
          <div className="w-[60%] lg:w-[60%] flex justify-center lg:py-0 py-8 max-lg:w-full max-lg:px-4 max-lg:py-6">
            <div className="w-[350px] mx-auto lg:mt-10 mt-0 max-lg:w-full max-lg:max-w-[350px]">
              ...
              <div className="flex justify-center items-center text-[12px] text-[#101011] w-full lg:ml-35 max-lg:flex-wrap max-lg:text-center max-lg:gap-1 mb-4">
                ...
                <div className="h-4 bg-gray-300 rounded w-24 ml-2 animate-pulse cursor-pointer"></div>
              </div>
  
              {/* Title */}
              <div className="text-[25px] text-[#636AE8] font-bold mt-5 lg:mt-0 lg:text-left text-center mb-6">
                <div className="h-8 bg-gray-300 rounded w-28 mx-auto lg:mx-0 animate-pulse"></div>
              </div>
              ...
              <div className="space-y-5">
                ...
                {/* Phone Number */}
                <div className="flex flex-col">
                  <div className="h-4 w-28 bg-gray-300 rounded mb-1 animate-pulse"></div>
                  <div className="h-10 bg-gray-300 rounded animate-pulse"></div>
                </div>
              </div>
