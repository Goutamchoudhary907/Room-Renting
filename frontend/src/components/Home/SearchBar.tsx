...
export const SearchBar = () => {
  ...
  const tagline =
    isLoggedIn && user
      ...
      : "Flexible rentals tailored to your lifestyle";
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black to-transparent opacity-15 z-0"></div>

        <div className="text-white flex flex-col items-center justify-center text-center relative z-10 px-4">
          {isLoggedIn && user ? (
            <>
              <h2 className="text-2xl sm:text-3xl md:text-2xl lg:text-[30px] xl:text-5xl font-bold pt-5 sm:pt-16 md:pt-8 lg:pt-16 leading-tight">
                Welcome back, {user.firstName}!
              </h2>
              <span className="hidden sm:inline-block text-xl sm:text-2xl md:text-2xl lg:text-[30px] xl:text-5xl font-bold mt-1 sm:mt-2">
                Ready to explore?
              </span>
            </>
          ) : (
            <>
              {/* MOBILE: Only show "Find Your Perfect Stay" */}
              <h2 className="block sm:hidden text-2xl font-bold pt-5">
                Find Your Perfect Stay
              </h2>

              {/* LAPTOP/TABLET: Original 2-line heading */}
              <h2 className="hidden sm:block text-2xl sm:text-3xl md:text-2xl lg:text-[30px] xl:text-5xl lg:px-40 font-bold sm:pt-16 md:pt-8 lg:pt-16 md:px-40 leading-tight">
          ...
          <h4 className="hidden lg:block text-base sm:text-lg mt-2 sm:mt-3 md:mt-0 md:text-base lg:text-xl lg:pt-0 xl:pt-4">
            {tagline}
          </h4>
        </div>
